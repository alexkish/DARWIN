...
#include "DARWINParticleSourceMessenger.hh"

DARWINParticleSourceMessenger::DARWINParticleSourceMessenger(DARWINParticleSource *pParticleSource):
	m_pParticleSource(pParticleSource), m_bShootIon(false)
{
	...
	m_pTypeCmd->SetCandidates("Point Volume RandomSphere");
...
DARWINParticleSourceMessenger::~DARWINParticleSourceMessenger()
{
	delete m_pTypeCmd;
	delete m_pShapeCmd;
	delete m_pCenterCmd;
...
void
DARWINParticleSourceMessenger::SetNewValue(G4UIcommand * command, G4String newValues)
{
