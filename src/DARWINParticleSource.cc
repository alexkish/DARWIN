...
#include "DARWINParticleSource.hh"

DARWINParticleSource::DARWINParticleSource()
{
	...
	m_pMessenger = new DARWINParticleSourceMessenger(this);
...
void
DARWINParticleSource::SetParticleDefinition(G4ParticleDefinition * aParticleDefinition)
{
...
void
DARWINParticleSource::SetEnergyFile(G4String hEnergyFile)
{
...
G4bool
DARWINParticleSource::ReadEnergySpectrum()
{
...
void
DARWINParticleSource::ConfineSourceToVolume(G4String hVolumeList)
{
...
void
DARWINParticleSource::GeneratePointSource()
{
...
void
DARWINParticleSource::GeneratePointsInVolume()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
DARWINParticleSource::SetRandomSpherePos()
{
	...
	G4double r[3],dir[3],D[9];  // random  vector pointing "somewhere down", direction vector, rot. matrix (eulrer angles)
	...
	for (i=0;i<3;i++) dir[i]=0;   // this is a stupid Matrix*vector multiplication: D*dir, there is a more elegant way for sure ...
	...
	m_hParticlePosition.setZ(pos_z); // (if necessary) shift center of the sphere to suit shield geometry
...
G4bool
DARWINParticleSource::IsSourceConfined()
{
...
void
DARWINParticleSource::GenerateIsotropicFlux()
{
	G4double rndm, rndm2;
	G4double px, py, pz;
...
void
DARWINParticleSource::GenerateMonoEnergetic()
{
	m_dParticleEnergy = m_dMonoEnergy;
}

void
DARWINParticleSource::GenerateEnergyFromSpectrum()
{
	m_dParticleEnergy = m_hEnergySpectrum.GetRandom()*MeV;
}

void
DARWINParticleSource::GeneratePrimaryVertex(G4Event * evt)
{
...
void
DARWINParticleSource::GeneratePrimaryVertexFromTrack(G4Track *pTrack, G4Event *pEvent)
{
