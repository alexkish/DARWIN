...
DARWINDetectorMessenger::DARWINDetectorMessenger(DARWINDetectorConstruction *pXeDetector)
...
DARWINDetectorMessenger::~DARWINDetectorMessenger()
{
...
void DARWINDetectorMessenger::SetNewValue(G4UIcommand *pUIcommand, G4String hNewValue)
{
