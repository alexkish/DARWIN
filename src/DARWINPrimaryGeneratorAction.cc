...
DARWINPrimaryGeneratorAction::DARWINPrimaryGeneratorAction()
{
	m_pParticleSource = new DARWINParticleSource();
...
void
DARWINPrimaryGeneratorAction::GeneratePrimaries(G4Event *pEvent)
{
