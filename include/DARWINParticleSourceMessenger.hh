...
class DARWINParticleSourceMessenger: public G4UImessenger
{
public:
	DARWINParticleSourceMessenger(DARWINParticleSource *pParticleSource);
	~DARWINParticleSourceMessenger();
